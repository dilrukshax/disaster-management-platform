...
app.post("/api/v1/volunteers", authMiddleware, (req, res) => {
...
app.patch("/api/v1/volunteers/:id/availability", authMiddleware, (req, res) => {
...
app.post("/api/v1/resources", authMiddleware, (req, res) => {
